...
class _BrowserReceiveScreenState extends State<BrowserReceiveScreen> {
  ...
  /// Uses READ_MEDIA_* for Android 13+ or storage for older versions
  Future<bool> _requestStoragePermission() async {
    if (!Platform.isAndroid) return true;

    // For Android 13+, use granular media permissions
    if (await _checkAndroid13Permissions()) {
      return true;
    }
  ...
  /// Check for Android 13+ granular media permissions
  Future<bool> _checkAndroid13Permissions() async {
    ...
    // Also try videos for video files
