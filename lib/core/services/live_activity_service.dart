...
class LiveActivityService {
  ...
  static Future<void> initialize() async {
    ...
    try {
      ...
      if (isSupported == true) {
        _isInitialized = true;
        print('✅ Live Activity service initialized');
      } else {
        print('ℹ️ Live Activities not supported on this platform');
      }
    } catch (e) {
      print('❌ Failed to initialize Live Activity service: $e');
    }
  }
  ...
  static Future<String?> startTransferActivity({
    ...
    if (!_isInitialized) {
      print('⚠️ Live Activity not available');
      return null;
    }
  ...
  static Future<void> updateProgress({
    ...
    try {
      ...
      print('❌ Failed to update Live Activity progress: $e');
    }
  }
  ...
  static Future<void> updateTransferState({
    ...
    try {
      ...
      print('❌ Failed to update Live Activity state: $e');
    }
  }
