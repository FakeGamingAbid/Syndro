...
class WindowSettingsService {
  ...
  static Future<void> saveWindowBounds({
    ...
    try {
      ...
      print('✅ Window bounds saved: ${size.width}x${size.height}, maximized: $maximized');
    } catch (e) {
      print('❌ Failed to save window bounds: $e');
    }
  }
  ...
  static Future<WindowBounds?> loadWindowBounds() async {
    ...
    try {
      ...
      if (width == null || height == null) {
        print('ℹ️ No saved window bounds found');
        return null;
      }
      ...
      print('✅ Window bounds loaded: $bounds');
      return bounds;
    } catch (e) {
      print('❌ Failed to load window bounds: $e');
      return null;
    }
  }
  ...
  static Future<void> clearSettings() async {
    ...
    try {
      ...
      print('✅ Window settings cleared');
    } catch (e) {
      print('❌ Failed to clear window settings: $e');
    }
  }
