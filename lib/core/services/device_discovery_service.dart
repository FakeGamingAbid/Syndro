...
class DeviceDiscoveryService {
  static const int _defaultPort = AppConfig.defaultTransferPort;
  static const List<int> _scanPorts = AppConfig.discoveryPorts;
  ...
  Future<void> _startUdpDiscovery() async {
    ...
    try {
      ...
      const baseUdpPort = AppConfig.udpDiscoveryPort;
      const maxRetries = 5;
