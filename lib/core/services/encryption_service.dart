...
class EncryptionService {
  ...
  // BUG-005 FIX: Expose static instance to avoid duplicate AesGcm instances across codebase
  static final AesGcm aesGcm = AesGcm.with256bits();
  final AesGcm _aesGcm = aesGcm; // Use static instance for instance methods
