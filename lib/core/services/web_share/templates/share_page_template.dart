...
<head>
  ...
  <style>
    * {
    ...
    /* ========================================
       LIGHTBOX / IMAGE PREVIEW MODAL STYLES
       ======================================== */
...
<body>
  ...
  <script>
    ...
    // Store all files and image files for navigation
    let allFiles = [];
    let imageFiles = [];
    ...
    function showCurrentImage() {
      ...
      // Set image source (use thumbnail URL which serves full image)
    ...
    async function loadFiles() {
      try {
        ...
        // Store files for lightbox navigation
        allFiles = data.files;
        imageFiles = data.files.filter(f => f.isImage);
        
        container.innerHTML = data.files.map(file => {
          if (file.isImage) {
            // Image file with clickable thumbnail
        ...
        document.getElementById('file-list').innerHTML = 
          '<div class="empty">' + icons.file + '<p>Error loading files</p></div>';
      }
    }
