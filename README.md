...
|----------|--------------|-------|
| Windows 10/11 | ✅ Full | Right-click context menu, double-click to restore |
| macOS 13-15 | ✅ Full | Menu bar icon, click to restore |
| **Linux - GNOME** | ⚠️ Limited | Requires `gnome-extension` or AppIndicator extension |
| **Linux - KDE** | ✅ Full | Standard system tray works |
| **Linux - Other** | ⚠️ Varies | Depends on desktop environment |

#### Linux Tray Notes
- **GNOME**: By default, GNOME does not support system tray icons. Install the [AppIndicator/KStatusNotifierItem](https://extensions.gnome.org/extension/615/appindicator-support/) extension for tray support.
- **KDE Plasma**: Full tray support out of the box.
- **XFCE, MATE, LXQt**: Usually work with standard tray implementations.

#### Testing Checklist
- [ ] Windows 10: Verify tray icon appears, right-click menu works
- [ ] Windows 11: Verify tray icon appears, double-click restores window
- [ ] macOS 13-15: Verify menu bar icon, click restores window
- [ ] Linux KDE: Verify tray icon and context menu
- [ ] Linux GNOME: Install AppIndicator extension, verify tray works
